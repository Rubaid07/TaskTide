...
const Register = () => {
    ...
    return (
       <div className="flex items-center min-h-[calc(100vh-286px)] justify-center">
      <div className="card bg-base-100 w-full max-w-sm mx-auto shrink-0 shadow-xl">
                ...
                <form onSubmit={handleRegister} className="card-body">
                    <fieldset className="fieldset">
                        ...
                        {passwordError && <p className='text-red-400 text-xs'>{passwordError}</p>}
                         ...
                         <button type='submit' className="btn btn-info text-white mt-4">Register</button>
        <button onClick={handleGoogleSignIn} className="btn bg-white text-black mt-2">
                          ...
                          <p className='text-center'>Already have an account? <Link className='text-info underline' to="/login">Login</Link></p>
                    </fieldset>
                </form>
            </div>
        </div>
